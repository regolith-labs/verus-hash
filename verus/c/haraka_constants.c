/* haraka_constants.c – base AES-derived round constants */

#include "haraka_portable.h"   /* brings in the extern */
...
// No writable global constants needed anymore.
// They will be generated on the stack per-call.
