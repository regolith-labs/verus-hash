...
// Provide static implementations for memcpy, memset, memcmp for SBF compatibility.
// Making them static gives them internal linkage, preventing symbol clashes
// with Rust's compiler_builtins during the final link stage.
// The -fno-builtin-memcpy flag in build.sh ensures the C code calls these
// static implementations instead of expecting external ones.
